    ...
    return(
        <nav className="relative mx-8 mb-24 flex justify-between items-center py-12 pb-6 font-medium md:mx-16 lg:mx-32">
            ...
            {!matches && (
                ...
                <motion.span animate={{rotateZ:toggled?45:0,y:toggled?8:0}} className="line-1 block h-0.5 w-8 bg-black"></motion.span>
                <motion.span animate={{width:toggled?0:24}} className="line-2 block h-0.5 w-6 bg-black"></motion.span>
            ...
            {toggled && !matches &&(
                ...
                className="fixed bg-white z-40 bottom-0 left-0 w-full h-screen items-center justify-center flex">
                    <motion.div variants={navMotion}
                    animate="visible" initial="hidden" className="flex flex-col gap-24 text-lg">
motion.a                <motion.a variants={itemMotion} href="/">Home</motion.a>
